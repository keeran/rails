...
module ActiveRecord
  module Core
    ...
    included do
      ...
      # To enable:
      #
      #    config.active_record.query_comments_enabled = true
      #
      ...
      #
      #    config.action_controller.query_comments_action_filter_enabled = false
      #
      # This behaviour can be disabled for +ActiveJob+ in a similar way:
      #
      #    config.active_job.query_comments_action_filter_enabled = false
      mattr_accessor :query_comments_enabled, instance_accessor: false, default: false
